...
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    window.api.on("rooms:append", (name) => {
...
function createPeerState() {
  const peers = /* @__PURE__ */ reactive({});
  function applyTopic(topic, value) {
...
function createRoster() {
  const entries = /* @__PURE__ */ reactive({});
  ...
  function setLocalPeer(peerId, peerName, localIP, publicIP) {
    entries[peerId] = {
      peerName,
      localIP,
      publicIP,
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const ownPeerId = /* @__PURE__ */ ref("");
    const ownPeerName = /* @__PURE__ */ ref("");
    window.api.invoke("bus:localPeer").then((info) => {
      if (info?.peerId) {
    ...
    window.api.on("peers:remote:joined", (info) => {
      roster.addPeer(info);
    });
    window.api.on("peers:remote:left", (info) => {
    ...
    window.api.on("peers:append", (info) => {
      roster.addPeer(info);
    });
    window.api.on("mqtt:message", (msg) => {
    ...
    const panelPeerId = /* @__PURE__ */ ref("");
    const panelChannel = /* @__PURE__ */ ref(0);
    function onCellClick(peerId, channelIndex) {
    ...
    async function onAddDevice(peerId, channelIndex, deviceType) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        panelOpen.value ? (openBlock(), createBlock(DevicePanel, {
          ...
          "channel-index": panelChannel.value,
